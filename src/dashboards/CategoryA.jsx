...
function CategoryA({ config, setConfig }) {
  const categoryKey = "category-a";
  ...
  const [counts, setCounts] = usePersistentState('categoryA_counts', [0, 0, 0, 0, 0, 0]);
  ...
  const [objectifs, setObjectifs] = usePersistentState('objectifsA', [50, 50, 50, 50, 50, 50]);
